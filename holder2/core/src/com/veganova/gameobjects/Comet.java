 ...
 */
public class Comet implements Movable {
    ...
    public Comet(float x, float y, float r, float px, float py)
    {
        type = "comet";
        exploded = false;
        radius = r;
    ...
    {
        batcher.draw(AssetLoader.comet, x - radius, y - radius, radius*2, radius*2);
    }
